<?php
// source: C:\xampp\htdocs\suri\app/config/config.neon 
// source: C:\xampp\htdocs\suri\app/config/config.local.neon 

class Container_2c838e7fb6 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'App\Forms\NewInsuranceFormFactory' => [1 => ['25_App_Forms_NewInsuranceFormFactory']],
			'App\Forms\SignInFormFactory' => [1 => ['26_App_Forms_SignInFormFactory']],
			'App\Forms\SignUpFormFactory' => [1 => ['27_App_Forms_SignUpFormFactory']],
			'App\Model\BaseModel' => [1 => ['28_App_Model_InsuranceModel']],
			'App\Model\InsuranceModel' => [1 => ['28_App_Model_InsuranceModel']],
		...
		'services' => [
			...
			'25_App_Forms_NewInsuranceFormFactory' => 'App\Forms\NewInsuranceFormFactory',
			'26_App_Forms_SignInFormFactory' => 'App\Forms\SignInFormFactory',
			'27_App_Forms_SignUpFormFactory' => 'App\Forms\SignUpFormFactory',
			'28_App_Model_InsuranceModel' => 'App\Model\InsuranceModel',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\suri\app',
			'wwwDir' => 'C:\xampp\htdocs\suri\www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'consoleMode' => FALSE,
			'tempDir' => 'C:\xampp\htdocs\suri\app/../temp',
		];
	}
	...
	public function createService__25_App_Forms_NewInsuranceFormFactory(): App\Forms\NewInsuranceFormFactory
	{
		$service = new App\Forms\NewInsuranceFormFactory($this->getService('24_App_Forms_FormFactory'),
			$this->getService('database.default.context'), $this->getService('28_App_Model_InsuranceModel'));
		return $service;
	}
	...
	public function createService__28_App_Model_InsuranceModel(): App\Model\InsuranceModel
	{
		$service = new App\Model\InsuranceModel($this->getService('database.default.context'));
		return $service;
	}
	...
	public function createServiceApplication__3(): App\Presenters\HomepagePresenter
	{
		...
		$service->injectPrimary($this, $this->getService('application.presenterFactory'),
			...
			$this->getService('http.response'), $this->getService('session.session'),
			$this->getService('security.user'), $this->getService('latte.templateFactory'));
		$service->newInsuranceFormFactory = $this->getService('25_App_Forms_NewInsuranceFormFactory');
		$service->invalidLinkMode = 5;
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, 'C:\xampp\htdocs\suri\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\suri\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\suri\app/../temp/cache',
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=suri', 'root',
			NULL, ['lazy' => TRUE]);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_2c838e7fb6 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\suri\app/../temp/cache/latte');
